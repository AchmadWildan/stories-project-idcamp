...
export function generateAuthenticatedNavigationListTemplate() {
  return `
    <li id="push-notification-tools" class="push-notification-tools"></li>
    <li><a id="new-report-button" class="btn new-report-button" href="#/new">Create Story<i class="fas fa-plus"></i></a></li>
  ...
  return `
    <div tabindex="0" class="report-item" data-reportid="${id}">
      ...
      <div class="report-item__body">
        ...
        <a class="btn report-item__read-more" href="#/stories-detail/${id}">
  ...
  return `
    ...
    <div class="container">
      <div class="report-detail__images__container">
        ...
        <img class="report-detail__image" src="${photoUrl}" alt="${name}">
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="report-detail__body">
        ...
        <div class="report-detail__body__map__container">
          <h2 class="report-detail__map__title">Lokasi Cerita:</h2>
